...
PatchscopeExperiment and source_overrides.
"""
...
PATCHSCOPE_DIR = Path(__file__).parent  # experiments/patchscope/
...
def _load_patchscope_config(config_filename: str) -> dict:
    """Load patchscope-specific YAML config from experiments/patchscope/."""
    path = PATCHSCOPE_DIR / config_filename
    if not path.exists():
