...
def run_logit_lens(
    ...
    transformer_layers = helpers._get_transformer_layers(model)
    ...
    if all_tokens:
        ...
        resolved_pos, _ = helpers.resolve_extraction_token_index(
...
class LogitLensCollector:
    ...
    def from_experiment(cls, experiment) -> "LogitLensCollector | None":
        ...
        layer_indices = helpers._resolve_layers(layer_spec, num_layers)
    ...
    def process_question(
        ...
        if "source" in self.phases:
            ...
            if is_manual:
                ...
                tok_pos = helpers.find_token_position(
        ...
        if "reporter" in self.phases:
            ...
            placeholder_token_id = helpers._get_placeholder_token_id(
            ...
            templates = helpers.effective_interpretation_templates(self.ps_config)
            ...
            for rp_name in reporter_persona_names:
                ...
                for tmpl_name, tmpl_cfg in templates.items():
                    for style in helpers.resolve_prompt_styles_for_tmpl_cfg(
