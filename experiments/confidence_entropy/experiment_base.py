...
from core.task_loader import sample_tasks
from experiments.base import BaseExperiment
from experiments.confidence_entropy.base_model_prompts import (
    format_confidence_prompt_base,
    format_mc_prompt_base,
    get_question_prefix,
    get_persona_context,
)
from experiments.confidence_entropy.experiment import (
...
class ConfidenceEntropyBase(BaseExperiment):
    ...
    def setup(self) -> None:
        ...
        from core.dataset_builder import build_confidence_entropy_dataset
